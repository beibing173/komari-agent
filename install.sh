...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.fryfries13.cn/https://github.com/komari-monitor/komari-agent/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.fryfries13.cn/https://github.com/komari-monitor/komari-agent/releases/${download_path}/${file_name}"
fi
